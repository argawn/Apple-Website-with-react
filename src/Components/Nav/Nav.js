        ...
        <div className="nav-wrapper fixed-top">
            <div className="container">
              ...
              ☰
                    ...
                    <a className="navbar-brand mx-auto logo-link" href="/"><img src={Logo} /></a>
                        ...
                        <ul className="navbar-nav nav-justified w-100 nav-fill">
                            <div className="top-link">
                                ...
                                <li className="list-inline-item">
                                    <a className="nav-link js-scroll-trigger" href="/Search apple.com">Search apple.com</a >
                ...
                <li className="nav-item">
                  <a className="nav-link js-scroll-trigger" href="/Mac">Mac</a>
                                ...
                                <li className="nav-item">
                                    <a className="nav-link js-scroll-trigger" href="/cart"><img src={Cart}/></a>
                                </li>
                        </ul>
                        </div>
                </nav>
